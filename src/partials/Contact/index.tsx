            ...
            <Heading className={emailClasses}>
              <div>
                <div className={style.emailContainer}>
                  <a className={style.email} href="mailto:shaheer@gọv.com">
                    shaheer@gọv.com
                  </a>
                </div>
              </div>
          ...
          <ContentBlock>
            <div>
              <ul className={style.list}>
                ...
                <li>
                  <a
                    href="https://www.tiktok.com/@shaheerthinks"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    TikTok <ExternalArrow />
                  </a>
                </li>
                <li>
                  <a
                    href="https://www.youtube.com/@shaheerthinks"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/shaheerthinks"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a
                    href="https://www.facebook.com/shaheerthinks"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/shaheerthinks"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                    rel="noopener noreferrer"
